...
*/
   ...
   iEvent.put( std::move( unique_ptr<double>(new double(MaxHFen))),  std::string("maxHFen"));
   iEvent.put( std::move( unique_ptr<double>(new double(MaxHFPen))), std::string("maxHFPen"));
   iEvent.put( std::move( unique_ptr<double>(new double(MaxHFNen))), std::string("maxHFNen"));
   iEvent.put( std::move( unique_ptr<double>(new double(MaxHFeta))), std::string("maxHFeta"));
   iEvent.put( std::move( unique_ptr<double>(new double(MaxHFphi))), std::string("maxHFphi"));
}
